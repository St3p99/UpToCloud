...
public class SearchService {
    ...
    // QUERY
    // 1.CONTAINS SPECIFIED TAG
    //   queryType=full&search=/.*vuoto.*/&searchFields=tags
//    queryType=full&search=/.*pino.*/||/.*mario.*/&searchFields=tags&search=learning
...
//    }
    ...
    public List<Document> searchByAnyFieldsContainsAndTags(String userID, boolean searchInContent, String text, List<String> tags) throws ResourceNotFoundException {
        ...
        String filter =
                String.format("search.in(id, %s)", ids)
    ...
    public void runIndexer(String containerName) {
        SearchIndexer indexer = getOrCreateAndGetSearchIndexer(containerName);
